<br><br><br><br>
Tutorials:
- How do I export a game into .exe? [Making A Game in C With Raylib BMo](https://www.youtube.com/watch?v=wwBktq791Qo)
  - Raylib supports .wav for audio (issues on itch.io submission)
- [raylib projects showcase 2024](https://youtu.be/GdlGE-eDlzg)
- [raylib projects showcase 2024](https://youtu.be/i7isROcHwWE)
